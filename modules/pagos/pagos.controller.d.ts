...
export declare class PagosController {
    ...
    create(createPagoDto: CreatePagoDto): Promise<import("mongoose").Document<unknown, {}, import("./entities/pago.entity").Pago> & import("./entities/pago.entity").Pago & {
        _id: import("mongoose").Types.ObjectId;
    }> | {
        error: any;
    };
    findOne(id: string): Promise<import("mongoose").Document<unknown, {}, import("./entities/pago.entity").Pago> & import("./entities/pago.entity").Pago & {
        _id: import("mongoose").Types.ObjectId;
    }> | {
        error: any;
    };
    update(id: string, updatePagoDto: UpdatePagoDto): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.PaymentIntent> | {
        error: string;
    }>;
    confirmar(id: string): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.PaymentIntent> | {
        error: string;
    }>;
    actualizarPagoEfectivo(id: string, estado: EstadoPagoDto): Promise<{
        message: string;
    }>;
    getFilter(filter: FilterPagoDto): Promise<{
        pagos: Omit<Omit<import("mongoose").Document<unknown, {}, import("./entities/pago.entity").Pago> & import("./entities/pago.entity").Pago & {
            _id: import("mongoose").Types.ObjectId;
        }, never>, never>[];
        total: number;
    }>;
    updateIntento(id: string, updatePagoDto: OtrosPagoDto): Promise<import("mongoose").Document<unknown, {}, import("./entities/pago.entity").Pago> & import("./entities/pago.entity").Pago & {
        _id: import("mongoose").Types.ObjectId;
    }>;
}

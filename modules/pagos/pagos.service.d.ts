...
export declare class PagosService {
    ...
    findPagobyManilla(id: string): Promise<import("mongoose").Document<unknown, {}, Pago> & Pago & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    findOne(id: string): Promise<import("mongoose").Document<unknown, {}, Pago> & Pago & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    ...
    getFilter(filter: FilterPagoDto): Promise<{
        pagos: Omit<Omit<import("mongoose").Document<unknown, {}, Pago> & Pago & {
            _id: import("mongoose").Types.ObjectId;
        }, never>, never>[];
        total: number;
    }>;
    updateIntento(id: string, updatePagoDto: OtrosPagoDto): Promise<import("mongoose").Document<unknown, {}, Pago> & Pago & {
        _id: import("mongoose").Types.ObjectId;
    }>;
